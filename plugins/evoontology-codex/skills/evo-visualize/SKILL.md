---
name: evo-visualize
description: Visualize the current EvoOntology state as an interactive local ontology graph.
---
...
4. Return the generated path `<resolved-workspace>/visualizations/ontology-layer-explorer.html`
